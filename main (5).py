...
print(result)
print("\nLinear Search Performed")#Here we write a function linear search product that lists product and target product and do the tasks which given in challenge.
